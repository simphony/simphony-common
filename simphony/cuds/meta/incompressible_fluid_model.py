...
class IncompressibleFluidModel(CompressibilityModel):
    ...
    cuba_key = cb.CUBA.INCOMPRESSIBLE_FLUID_MODEL
    ...
    def __init__(self, description=None, name=None, data=None):
        ...
        # This is a system-managed, read-only attribute
        self._variables = [cb.CUBA.VELOCITY, cb.CUBA.POSITION, cb.CUBA.DENSITY, cb.CUBA.VISCOSITY]
    ...
    @classmethod
    def parents(cls):
        return (cb.CUBA.COMPRESSIBILITY_MODEL, cb.CUBA.PHYSICS_EQUATION, cb.CUBA.MODEL_EQUATION, cb.CUBA.CUDS_COMPONENT, cb.CUBA.CUDS_ITEM)
