...
class IsothermalModel(ThermalModel):
    ...
    cuba_key = cb.CUBA.ISOTHERMAL_MODEL
    ...
    @classmethod
    def parents(cls):
        return (cb.CUBA.THERMAL_MODEL, cb.CUBA.PHYSICS_EQUATION, cb.CUBA.MODEL_EQUATION, cb.CUBA.CUDS_COMPONENT, cb.CUBA.CUDS_ITEM)
