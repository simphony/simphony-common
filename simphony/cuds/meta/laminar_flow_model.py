...
class LaminarFlowModel(TurbulenceModel):
    ...
    cuba_key = cb.CUBA.LAMINAR_FLOW_MODEL
    ...
    @classmethod
    def parents(cls):
        return (cb.CUBA.TURBULENCE_MODEL, cb.CUBA.PHYSICS_EQUATION, cb.CUBA.MODEL_EQUATION, cb.CUBA.CUDS_COMPONENT, cb.CUBA.CUDS_ITEM)
