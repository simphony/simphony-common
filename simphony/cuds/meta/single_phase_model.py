...
class SinglePhaseModel(MultiphaseModel):
    ...
    cuba_key = cb.CUBA.SINGLE_PHASE_MODEL
    ...
    @classmethod
    def parents(cls):
        return (cb.CUBA.MULTIPHASE_MODEL, cb.CUBA.PHYSICS_EQUATION, cb.CUBA.MODEL_EQUATION, cb.CUBA.CUDS_COMPONENT, cb.CUBA.CUDS_ITEM)
