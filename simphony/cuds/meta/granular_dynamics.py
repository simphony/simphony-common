...
class GranularDynamics(PhysicsEquation):
    ...
    cuba_key = cb.CUBA.GRANULAR_DYNAMICS
    ...
    def __init__(self, description=None, name=None, data=None):
        ...
        self._models = [cb.CUBA.MESOSCOPIC]
        # This is a system-managed, read-only attribute
        self._definition = 'Granular dynamics of spherical particles using DEM'  # noqa
        # This is a system-managed, read-only attribute
        self._variables = [cb.CUBA.POSITION, cb.CUBA.VELOCITY, cb.CUBA.MOMENTUM, cb.CUBA.ACCELERATION, cb.CUBA.MOMENT_INERTIA, cb.CUBA.TORQUE, cb.CUBA.ANGULAR_VELOCITY]
